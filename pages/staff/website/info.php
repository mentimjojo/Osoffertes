<div class="well">
    <ul class="nav nav-tabs">
      ...
      <li><a href="<?= URL; ?>/info/phpinfo" target="_blank">PHP info</a></li>
    </ul>
    <div id="myTabContent" class="tab-content">
      ...
      <div class="tab-pane fade" id="change">
        Alle changelogs:
		<br/><br/>
		<strong>Changelog 1:</strong> <a href="<?= URL; ?>/info/changelog/1" target="_blank">Klik hier</a>
		<br/>
		<strong>Changelog 2:</strong> <a href="<?= URL; ?>/info/changelog/2" target="_blank">Klik hier</a>
      </div>
  </div>
